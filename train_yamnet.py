...
from yamnet_model import HeartYAMNet
...
optimizer = optim.Adam(model.model.classifier.parameters(), lr=1e-3, weight_decay=1e-4)
...
torch.save(model.state_dict(), 'yamnet_ultimate_model.pth')
print("Model saved to yamnet_ultimate_model.pth!")